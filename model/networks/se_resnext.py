...
# ==============================================================================
# from https://github.com/HiKapok/TF-SENet/blob/master/se_resnext.py
...
def SE_ResNeXt(input_image, num_classes, is_training=False, group=32, data_format='channels_last', net_depth=50):
    ...
    inputs_features = tf.layers.conv2d(swaped_input_image,
                                       input_depth[0] // 4,
                                       (7, 7),
                                       use_bias=False,
                                       name='conv1/7x7_s2',
    ...
    inputs_features = tf.layers.batch_normalization(inputs_features,
    ...
    logits_output = tf.layers.dense(pooled_inputs,
                                    num_classes,
                                    kernel_initializer=tf.contrib.layers.xavier_initializer(),
                                    bias_initializer=tf.zeros_initializer(),
                                    use_bias=True)
