...
def data_generator(dataset,
    ...
    while True:
        try:
            ...
            batch_images[b] = meta.mold_image(image.astype(np.float32), config)
...
def load_image_gt(dataset,
    ...
    # Image meta data
    image_meta = meta.compose_image_meta(image_id, original_shape, image.shape, window, scale, active_class_ids)
...
def build_detection_targets(rpn_rois, gt_class_ids, gt_boxes, config):
    ...
    # It's common to add GT Boxes to ROIs but we don't do that here because according to XinLei Chen's paper, it doesn't help.
